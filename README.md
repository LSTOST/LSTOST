...
独立开发者 / 创作者，常驻大湾区。  
正在探索 **AGI 时代的个体生存指南**。写代码和写字一样，都是为了让日常运转得更顺畅。
...
在真实场景中做有意思、能解决具体问题的小工具：

- 🎨 **[SayUI](https://www.sayui.app)**  
...
- **核心语言与框架**：TypeScript · React 19 · Next.js · Astro
- **界面与交互**：Tailwind CSS · Framer Motion · Radix UI
- **数据与边缘**：Prisma · SQLite / MySQL · Cloudflare Workers / Pages
